...
public class GeneratorsClassFile {
	...
	public static void generatorS(String name) throws IOException {
		File file = new File("C:/Users/Administrator/Desktop/xxd/xxd/src/main/java/com/xxd/services/"+name+"S.java");
	...
	public static void generatorSI(String name) throws IOException {
		File file = new File("C:/Users/Administrator/Desktop/xxd/xxd/src/main/java/com/xxd/services/impls/"+name+"SI.java");
		if(!file.exists()) file.createNewFile();
		PrintWriter pw = new PrintWriter(new FileOutputStream(file, true));
		//定义package
	...
	public static void generatorC(String name) throws IOException {
		File file = new File("C:/Users/Administrator/Desktop/xxd/xxd/src/main/java/com/xxd/controllers/"+name+"C.java");
		if(!file.exists()) file.createNewFile();
		PrintWriter pw = new PrintWriter(new FileOutputStream(file, true));
		//定义package
	...
	public static void main(String[] args) throws IOException {
		...
		//}
		generatorS("XxdGoodsFlashBak");
		generatorSI("XxdGoodsFlashBak");
		generatorC("XxdGoodsFlashBak");
		generatorS("XxdGoodsPriceFlashBak");
		generatorSI("XxdGoodsPriceFlashBak");
		generatorC("XxdGoodsPriceFlashBak");
	}
