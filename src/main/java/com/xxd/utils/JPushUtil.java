...
public class JPushUtil {
    ...
    public static PushPayload buildPushObject(JPushPayload jPushPayload) throws Exception{
        ...
        //设置推送平台
        if (JPushPayload.PlatformDesc.Android.getValue().equals(jPushPayload.getPlatform())) {
        ...
        //设置推送观众
        if (JPushPayload.AudienceDesc.alias.getValue().equals(jPushPayload.getAudience())) {
            pushBuilder.setAudience(Audience.alias(jPushPayload.getAliases()));
        } else if (JPushPayload.AudienceDesc.tag.getValue().equals(jPushPayload.getAudience())) {
