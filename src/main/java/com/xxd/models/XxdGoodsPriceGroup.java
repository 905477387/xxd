...
public class XxdGoodsPriceGroup {
    ...
    public XxdGoodsPriceGroup(XxdGoodsPrice goodsPrice, BigDecimal profit){
    	setFormatName(goodsPrice.getFormatName());
    	setMemberPrice(goodsPrice.getMemberPrice());
    	BigDecimal price = goodsPrice.getPrice();
		BigDecimal price3 = goodsPrice.getMemberPrice().subtract(price);
		BigDecimal price4 = price3.multiply(profit);
		BigDecimal price5 = goodsPrice.getMemberPrice().subtract(price4);
    	setGroupMemberPrice(price5);
    	setMarketPrice(goodsPrice.getMarketPrice());
    	setImg(goodsPrice.getImg());
    	setPrice(goodsPrice.getPrice());
    }
    
    public XxdGoodsPriceGroup() {}
