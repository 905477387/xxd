...
public class XxdGoodsPriceGroupBakSqlProvider {
     ...
     * @mbggenerated
     */
    public String insertSelective(XxdGoodsPriceGroupBak record) {
        BEGIN();
        INSERT_INTO("xxd_goods_price_group_bak");
        
        if (record.getId() != null) {
            VALUES("id", "#{id,jdbcType=INTEGER}");
        }
        
        if (record.getGoodsGroupBakId() != null) {
            VALUES("goods_group_bak_id", "#{goodsGroupBakId,jdbcType=INTEGER}");
        }
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(XxdGoodsPriceGroupBak record) {
        BEGIN();
