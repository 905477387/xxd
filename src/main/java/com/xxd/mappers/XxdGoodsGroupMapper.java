...
public interface XxdGoodsGroupMapper {
    ...
    ArrayList<XxdGoodsGroup> selectByTimeEnd();
    ...
    @Select({
        ...
        "group_times, time, group_picture, group_title",
        "from xxd_goods_group",
        "where group_start_time = date_format(now(), '%Y-%m-%d 08:00:00')"
    })
    @Results({
        @Result(column="id", property="id", jdbcType=JdbcType.INTEGER, id=true),
        @Result(column="goods_id", property="goodsId", jdbcType=JdbcType.INTEGER),
    ...
    ArrayList<XxdGoodsGroup> selectByTimeNow(Integer id);
    ...
    @Select({
        ...
        "group_times, time, group_picture, group_title",
        "from xxd_goods_group",
        "where DATE_SUB(group_start_time, interval 1 day) = date_format(now(), '%Y-%m-%d 08:00:00')"
    })
    @Results({
        @Result(column="id", property="id", jdbcType=JdbcType.INTEGER, id=true),
        @Result(column="goods_id", property="goodsId", jdbcType=JdbcType.INTEGER),
    ...
    ArrayList<XxdGoodsGroup> selectByTimeNext();
    
    @Update({
        "update xxd_goods set grounding_sta = #{grounding_sta,jdbcType=SMALLINT}",
        "where id in (select goods_id from xxd_goods_group where group_start_time = date_format(now(), '%Y-%m-%d 08:00:00'))"
    })
    int updateGroupingStaIngGroup(Short grounding_sta);
    
    @Update({
        "update xxd_goods set grounding_sta = #{grounding_sta,jdbcType=SMALLINT}",
        "where id in (select goods_id from xxd_goods_group where group_end_time = date_format(now(), '%Y-%m-%d 22:00:00'))"
    })
    int updateGroupingStaOverGroup(Short grounding_sta);
    
    @Update({
        "update xxd_goods set grounding_sta = #{grounding_sta,jdbcType=SMALLINT}",
        "where id in (select goods_id from xxd_goods_group where DATE_SUB(group_start_time, interval 1 day) = date_format(now(), '%Y-%m-%d 08:00:00'))"
    })
    int updateGroupingStaPreGroup(Short grounding_sta);
    ...
    XxdGoodsGroup selectBygoodsId(Integer goods_id);
